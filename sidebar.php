<aside class="sidebar" aria-label="<?php esc_attr_e( '侧栏', 'xinaide-cloud' ); ?>">
	...
	<section class="widget cloud-panel contact-widget"><div class="widget-number">01</div><h2 class="widget-title"><?php echo esc_html( xinaide_cloud_get_option( 'contact_title' ) ); ?></h2><img src="<?php echo esc_url( xinaide_cloud_get_option( 'contact_qr' ) ); ?>" alt="<?php echo esc_attr( xinaide_cloud_get_option( 'contact_title' ) ); ?>"></section>
	<?php endif; ?>

	<?php if ( is_active_sidebar( 'sidebar-1' ) ) : ?>
		<?php dynamic_sidebar( 'sidebar-1' ); ?>
	<?php else : ?>
	<section class="widget cloud-panel search-widget"><div class="widget-number">02</div><h2 class="widget-title"><?php esc_html_e( '站内搜索', 'xinaide-cloud' ); ?></h2><?php get_search_form(); ?></section>
